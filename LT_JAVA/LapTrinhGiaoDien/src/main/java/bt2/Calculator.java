...
public class Calculator extends JFrame{
    ...
    public Calculator(String tittle){
     super(tittle);
    ...
    Calculator frm=new Calculator("Simple Calculator");
    frm.setVisible(true);
    }
...
//add(bt1=new JButton("BT1"), BorderLayout.NORTH);
//add(bt2=new JButton("BT2"), BorderLayout.SOUTH);
//add(bt3=new JButton("BT3"), BorderLayout.WEST);
//add(bt4=new JButton("BT4"), BorderLayout.EAST);
//add(bt5=new JButton("BT5"), BorderLayout.CENTER );
